...
public class UserHomePage extends AppCompatActivity implements JustinOnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = ToDoDatabase.getInstance(UserHomePage.this);
        ...
        if (username == null){
            ...
            if (preferences.contains("email")) {
                // User is already logged in, use that value
                username = preferences.getString("username", "User");
            }
        }

        //get id
        id = db.userDao().getIdFromUsername(username);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (justinTask != null && justinTask.UserId == id) {
